...
def write_pdb(
    ...
    reference = get_reference(structure.reference_key)
    lines = [
        "REMARK  Generated by Cellulose Modeler (cellulose_modeler)",
        f"REMARK  Allomorph: cellulose {structure.allomorph}",
        f"REMARK  Experimental source: {reference.metadata.data_source}",
        f"REMARK  {reference.metadata.citation}",
        f"REMARK  DOI: {reference.metadata.doi}",
        f"REMARK  Unit cell a,b,c: {reference.a:.5f} {reference.b:.5f} {reference.c:.5f} A",
        f"REMARK  Unit cell alpha,beta,gamma: {reference.alpha:.5f} "
        f"{reference.beta:.5f} {reference.gamma:.5f} degrees",
        "REMARK  Symmetry expansion and finite-chain construction by Cellulose Modeler",
        "REMARK  Heavy atoms and C-H coordinates derive from the cited structure",
